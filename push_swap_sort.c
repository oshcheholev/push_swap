...
/*   Updated: 2024/09/24 12:18:16 by oshcheho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	if (toporbot == 0)  // Move element from the top
// 	{
// 		while (i < what)
// 		{
// 			ra(ps);
...
// 		pb(ps);
// 	}
// 	else if (toporbot == 1)  // Move element from the bottom
// 	{
// 		while (i < what)
// 		{
// 			rra(ps);
...
// // 		{
// // 			to_move[1] = 0;
// // 			move_elem(ps, move_top, to_move[0], to_move[1]);
// // 		}
// // 		else
// // 		{
// // 			to_move[1] = 1;
// // 			move_elem(ps, move_bot, to_move[0], to_move[1]);
// // 		}
// // 	}
// // 	test_print(ps);
...
// 	int top_cost;
// 	int bot_cost;
// 	int to_move[2];  // [0] -> top or bottom, [1] -> whether to rotate after
...
// 		// Reset the index for each iteration over the stack
// 		i = 0;
// 		while (i < ps->a_len) 
// 		{
// 			printf("value %d place %d\n", ps->stack_a[i].value, ps->stack_a[i].place);

// 			// First element (smallest place)
// 			if (ps->stack_a[i].place == 0)
// 			{
// 				if (i <= ps->a_len / 2)  // Cheaper to rotate
// 				{
// 					move_top = i;
// 					top_cost = i;
// 					to_move[0] = 0;  // Top
// 				}
// 				else  // Cheaper to reverse rotate
// 				{
// 					move_top = ps->a_len - i;
// 					top_cost = ps->a_len - i;
// 					to_move[0] = 1;  // Bottom
...
// 		// Determine whether to move the top or bottom based on the cost
// 		printf("top cost %d bot cost %d\n", top_cost, bot_cost);
// 		if (top_cost <= bot_cost)  // Move the top element
// 		{
// 			move_elem(ps, top_cost, to_move[0], 0);  // 0 = no need to rotate `rb` after
// 		}
// 		else  // Move the bottom element
// 		{
// 			move_elem(ps, bot_cost, to_move[1], 1);  // 1 = rotate `rb` after
// 		}
// 	}
// 	test_print(ps);
// }
